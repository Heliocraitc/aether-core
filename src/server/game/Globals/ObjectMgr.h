...
#define MAX_PLAYER_NAME          30                         // max allowed by client name length
#define MAX_INTERNAL_PLAYER_NAME 30                         // max server internal player name length (> MAX_PLAYER_NAME for support declined names)
#define MAX_PET_NAME             30                         // max allowed by client name length
#define MAX_CHARTER_NAME         30                         // max allowed by client name length
